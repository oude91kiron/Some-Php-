...
<html>
   ...
   <body>
      ...
      <div class="img-box">
                     ...
                     <div class="detail-box" style="margin-top:50px; font-weight: bold;">
                        ...
                        <h5 style="margin-left:10px">
                         ...
                         <h6 style="color:red">
                           After Discount: {{$product->discount_price}}TL
                        </h6>    
                        
                        <h6 style="text-decoration:line-through; color:blue">
                           Before Discount: {{$product->price}}TL
                        </h6>                    
                        @else
